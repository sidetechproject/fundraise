<div class="left_col scroll-view">
    <div class="navbar nav_title border-0">
        <a href="{{route('admin_dashboard')}}" class="site_title">
            {{-- <i class="admin_logo"></i><span>ADMIN</span> --}}
            <img src="{{asset(setting('logo') ? 'uploads/' . setting('logo') : 'assets/images/assets/logo.png')}}" alt="logo" width="200px">
        </a>
    </div>

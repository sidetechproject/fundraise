            ...
            <td class="container">
                <div class="content">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <p>
                                                ...
                                                You have received an invite to add your startup to <strong>{{ $startup->name }}</strong> <br><br>
                    ...
                    <span class="apple-link">
                        {{setting('app_name')}} | United States | 2810 N Church St, PMB 36681 Wilmington, DE 19802 4447
                    </span>
                                    <br>
